...
<%
	...
	if(rs.first()){
		out.print("<table border=1><tr><th>Codigo</th><th>Nombre</th><th>Direccion</th><th>Saldo Adeudado</th><th>Estado</th></tr>");
		while(rs.next()){
			out.print("<tr><td>"+rs.getString("codigo")+"</td><td>"+rs.getString("nombre")+"</td><td>"+rs.getString("direccion")
			+"</td><td>"+rs.getString("saldoAdeudado")+"</td><td>"+rs.getString("estado")+"</td></tr>");
		}
		out.print("</tabla>");
	}else{
